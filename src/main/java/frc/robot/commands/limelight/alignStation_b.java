...
public class alignStation_b extends Command{
    ...
    public alignStation_b(Limelight3DDistance llm1, DriveSubsystem roboDrive,double wait){
        this.llm = llm1;
    ...
    @Override
    public void execute() {
        llm.reeflimelightB(m_robotDrive);
